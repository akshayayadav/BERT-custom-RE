...
def map_relations():
    ...
    abstract_dict = get_abstract_dict(base_path + "chemprot_test_abstracts.tsv")
    entities_dict = get_entities_dict(base_path + "chemprot_test_entities.tsv")
    relations_filename = base_path + "chemprot_test_gold_standard_withNOT_mapped.tsv"
    relation_triplet_outfile = open(base_path+"chemprot_test_gold_standard_withNOT_triplets.tsv",
                                    "w")
    skipped_relations_outfile = open(base_path+"chemprot_test_gold_standard_withNOT_skipped.tsv",
                                    "w")
